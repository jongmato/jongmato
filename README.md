...
**Solo Developer building products that matter**

`Next.js` · `React Native` · `FastAPI` · `Supabase`

[lifecarelog.co.kr](https://lifecarelog.co.kr) · [X (Twitter)](https://x.com/jongmato)
...
프론트엔드에서 시작해 풀스택으로 확장하고 있는 1인 개발자입니다.
**LifeCareLog** 브랜드 아래 여러 서비스를 만들고 있습니다.

- Working on **LifeCareLog** — AI-powered life management platform
- Building with Next.js 16, Expo SDK 55, FastAPI, Supabase
- Exploring AI agent workflows with LangGraph & n8n
...
[![Skills](https://skillicons.dev/icons?i=ts,react,nextjs,tailwind,python,fastapi,supabase,docker,cloudflare,figma&theme=light)](https://skillicons.dev)
...
|---------|-------------|-------|
| [**LifeCareLog**](https://lifecarelog.co.kr) | Brand landing & portfolio | Next.js 16, TailwindCSS V4, Framer Motion |
| **Plan-L** | AI legal information search | Next.js, FastAPI, LangGraph, Supabase |
| **Plan-T** | AI mental health platform | Expo, FastAPI, Supabase |
| **Plan-C** | Financial life planner | Next.js, Supabase |
